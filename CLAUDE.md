...
Статический сайт-банк вопросов с собеседований. Vite + TypeScript без фреймворков и рантайм-зависимостей. Дизайн — минималистичный чёрно-белый (светлая и тёмная тема через `data-theme` на `<html>`, начальное значение ставит инлайн-скрипт в `index.html`).
